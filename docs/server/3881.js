...
/* harmony import */ var _haptic_029a46f6_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./haptic-029a46f6.js */ 23797);
...
const PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
       ...
       */
      const enableHaptics = (0,_ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.a)('ios');
      const {
        el
      } = this;
      let timeout;
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]:not([disabled])`);
  }
  render() {
    const {
      items,
