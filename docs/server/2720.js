...
/* harmony import */ var _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-afea2bcf.js */ 53667);
/* harmony import */ var _framework_delegate_6a45ed30_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./framework-delegate-6a45ed30.js */ 26419);
...
class ViewController {
   ...
   */
  _destroy() {
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
const matches = (view, id, params) => {
  ...
  return (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.s)(view.params, params);
};
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = _ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('swipeBackEnabled', mode === 'ios');
    }
  ...
  componentDidLoad() {
    ...
    return (0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.rootChanged();
      _this2.gesture = (yield __webpack_require__.e(/*! import() */ 5898).then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-1bb66ed2.js */ 45898))).createSwipeBackGesture(_this2.el, _this2.canStart.bind(_this2), _this2.onStart.bind(_this2), _this2.onMove.bind(_this2), _this2.onEnd.bind(_this2));
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.d);
      view._destroy();
    }
  ...
  prepareTI(ti) {
    ...
    if (ti.removeView !== undefined) {
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(ti.removeStart !== undefined, 'removeView needs removeStart');
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(ti.removeCount !== undefined, 'removeView needs removeCount');
    ...
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(insertViews.length > 0, 'length can not be zero');
  ...
  postViewInit(enteringView, leavingView, ti) {
    var _a, _b, _c;
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(leavingView || enteringView, 'Both leavingView and enteringView are null');
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(ti.resolve, 'resolve must be valid');
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(ti.reject, 'reject must be valid');
    ...
    if (removeStart !== undefined && removeCount !== undefined) {
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(removeStart >= 0, 'removeStart can not be negative');
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(removeCount >= 0, 'removeCount can not be negative');
      destroyQueue = [];
    ...
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(finalNumViews >= 0, 'final balance can not be negative');
    if (finalNumViews === 0) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.b);
        (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.c);
        (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.d);
      }
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this10);
      ...
      const animationOpts = Object.assign(Object.assign({
        ...
        baseEl: _this10.el,
        progressCallback,
        animated: _this10.animated && _ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('animated', true),
        enteringEl,
        leavingEl
      }, opts), {
        animationBuilder: opts.animationBuilder || _this10.animation || _ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.c.get('navAnimation')
      });
      const {
        hasCompleted
      } = yield (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.t)(animationOpts);
  ...
  insertViewAt(view, index) {
    ...
    if (existingIndex > -1) {
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(view.nav === this, 'view is not part of the nav');
      // The view already in the stack, removes it.
      views.splice(existingIndex, 1);
      // and add it back at the requested index.
      views.splice(index, 0, view);
    } else {
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(!view.nav, 'nav is used');
   ...
   */
  removeView(view) {
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
    const views = this.views;
    const index = views.indexOf(view);
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.o)(index > -1, 'view must be part of the stack');
    if (index >= 0) {
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.l)(element, _index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_afea2bcf_js__WEBPACK_IMPORTED_MODULE_5__.s)(element, true);
        }
      }
    }
  }
