...
/* harmony import */ var _data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-b8307d99.js */ 55133);
...
const DatetimeButton = class {
  constructor(hostRef) {
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
      ...
      return new Promise(resolve => {
        (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_3__.a)(datetimeEl, 'ionRender', resolve, {
          once: true
        });
      });
    });
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
  ...
  componentWillLoad() {
    ...
    return (0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (datetimeEl.tagName !== 'ION-DATETIME') {
        (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_4__.a)(`Expected an ion-datetime instance for ID '${datetime}' but received '${datetimeEl.tagName.toLowerCase()}' instead.`, datetimeEl);
        return;
      }
      /**
      ...
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_3__.c)(datetimeEl, () => {
        ...
        (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_3__.a)(datetimeEl, 'ionValueChange', _this2.setDateTimeText);
        /**
