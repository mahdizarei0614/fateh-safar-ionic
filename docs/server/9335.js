...
/* harmony import */ var _form_controller_6cd7ebd1_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-controller-6cd7ebd1.js */ 14421);
...
const Radio = class {
  ...
  connectedCallback() {
    this.legacyFormController = (0,_form_controller_6cd7ebd1_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.el);
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.a)(radioGroup, 'ionValueChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.b)(radioGroup, 'ionValueChange', this.updateState);
      this.radioGroup = null;
    }
  }
  componentWillLoad() {
    ...
    if (!this.legacyFormController.hasLegacyControl()) {
      this.inheritedAttributes = Object.assign({}, (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el));
    }
  }
  styleChanged() {
    this.emitStyle();
...
const RadioGroup = class {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    (0,_helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__.d)(true, el, name, value, false);
    return (0,_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_36a5fd75_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      role: "radiogroup",
      "aria-labelledby": label ? labelId : null,
      onClick: this.onClick,
