...
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./theme-7670341c.js */ 35578);
/* harmony import */ var _helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-f586db1c.js */ 41099);
/* harmony import */ var _watch_options_4d421847_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./watch-options-4d421847.js */ 90838);
...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.contentEl = (0,_index_7373924f_js__WEBPACK_IMPORTED_MODULE_6__.f)(el);
      yield _this2.updateOptions();
      _this2.mutationObserver = (0,_watch_options_4d421847_js__WEBPACK_IMPORTED_MODULE_5__.w)(el, 'ion-item-option', /*#__PURE__*/(0,_home_ompfinex_IdeaProjects_fateh_safar_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this2.updateOptions();
      }));
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-422b6e83.js */ 96178))).createGesture({
        el,
  ...
  onStart() {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_7373924f_js__WEBPACK_IMPORTED_MODULE_6__.d)(contentEl);
    }
  ...
  onEnd(gesture) {
    ...
    if (contentEl) {
      (0,_index_7373924f_js__WEBPACK_IMPORTED_MODULE_6__.r)(contentEl, initialContentScrollY);
    }
